  ...
  return (
    <div className="container-fluid p-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      {weekDays.map((day, index) => (
                        <th key={index}>
                          <span className="badge rounded-pill text-bg-dark fs-13">{day.day}</span> {day.date}
                        </th>
                      ))}
                    </tr>
                  </thead>
                    ...
                    {loading ? (
                      ...
                      currentItems.map((employee, index) => (
                        <tr key={index} className={index > 0 ? "column" : ""}>
                          <td>
                            <span className="text-muted">{employee.EmpName}</span>
                            {employee.geoCode !== 'Y' && (
                          ...
                          {[0, 1, 2, 3, 4, 5, 6].map((day) => (
                            <td key={day} id={employee.EmployeeID}>
                              <a href="#!">
                                {employee[`SETime${day}`].split('!')[0].split('<BR>')[0]}<br />
     ...
     <Notifications/>
          ...
          <div className="d-flex justify-content-start align-items-start p-3">
            ...
            <div>
              ...
              <ul className="personal_info">
                <li><span className="material-icons">email</span> john@example.com</li>
                <li><span className="material-icons">call</span> 9627552410</li>
              </ul>
              <button className="btn btn-outline-secondary pi_btn">View Profile</button>
      ...
      {/* New Schedule Modal */}
      <div className="offcanvas offcanvas-end offcanvas_long" tabIndex="-1" id="raise_Feedback" aria-labelledby="offcanvasRightLabel">
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-6">
                      ...
                      <select className="form-select" defaultValue="0" id="ddlNewLoginShift">
                        <option value="0">Select</option>
                        <option value="N/A">N/A</option>
                        {LoginNewShiftPickup.map((loginnewshiftpickup) => (
                          <option key={loginnewshiftpickup.shiftTime} value={loginnewshiftpickup.shiftTime}>
