            ...
            <div className="middle">
                <div className="row">
                    <div className="col-12">
                        <h6 className="pageTitle">Vehicle Master <small>Allows to View, Edit and Add New Vehicle.</small></h6>
                    </div>
                    {/* Search Box */}
                    <div className="col-12">
                    ...
                    <PrimeSidebar visible={visibleLeft} position="right" onHide={() => setVisibleLeft(false)} width="50%" showCloseIcon={false} dismissable={false}>
                        ...
                        <div className="sidebarBody">
                            <div className="row">
                                ...
                                <div className="field col-12 mb-3 mt-3">
                                    <label>Remark</label>
