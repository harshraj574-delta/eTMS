            ...
            <div className="middle">
                <div className="row">
                    <div className="col-12">
                        <h6 className="pageTitle">Vendor Master <small>Allows to View, Edit and Add New Vendor.</small></h6>
                    </div>
                    {/* Search Box */}
                    <div className="col-12">
                    ...
                    <div className="col-12">
                        <div className="card_tb">
                            <DataTable value={[
                                ...
                                <Column field="driverName" header="Vendor Strength"></Column>
                                <Column field="facilityName" header="Vendor Strength2"></Column>
                                <Column field="vendorName" header="Vendor Strength3"></Column>
                        ...
                        <div className="sidebarBody">
                            <div className="row">
                                ...
                                <div className="field col-3 mb-3">
                                    ...
                                    <InputText className="form-control" name="" placeholder="Vendor Name" />
                                </div>
                                <div className="field col-3 mb-3">
                                    <label>Vendor Strength</label>
                                    <InputText className="form-control" name="" placeholder="Vendor Strength" />
                                </div>
                                <div className="field col-3 mb-3">
                                    <label>Vendor Strength 2</label>
                                    <InputText className="form-control" name="" placeholder="Vendor Strength 2" />
                                </div>
                                <div className="field col-3 mb-3">
                                    <label>Vendor Strength 3</label>
